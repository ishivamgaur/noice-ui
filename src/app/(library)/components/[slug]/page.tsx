...
export default async function ComponentPage({
 ...
 href={`/components?c=${encodeURIComponent(component.category)}`}
          className="mt-3 inline-flex h-7 items-center rounded-full bg-surface px-3 text-xs font-medium text-muted-foreground hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2"
 >
 {component.category}
 </Link>
 </div>
