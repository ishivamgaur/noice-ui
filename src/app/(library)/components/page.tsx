      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="relative w-full sm:max-w-64">
          ...
          <input
            ...
            className="h-9 w-full rounded-lg border border-border bg-transparent pr-10 pl-9 text-sm outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-muted-foreground/50"
          />
          <kbd
            aria-hidden
