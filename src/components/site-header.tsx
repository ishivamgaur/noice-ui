      ...
      <div className="mx-auto flex h-14 max-w-[90rem] items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Link
            ...
            className="hidden h-10 items-center rounded-lg bg-brand px-4 text-sm font-medium text-brand-foreground [box-shadow:inset_0_-1px_1px_#0003,inset_0_0_0_1px_#0000001f,0_1px_3px_#0000002b,inset_0_2px_#ffffff26] transition-all duration-200 hover:opacity-90 active:scale-[0.98] sm:inline-flex"
          >
            Get started
          </Link>
          <button
